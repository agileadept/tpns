...
class Stub
{
    ...
    public function Push($request)
    {
        ...
        $headers = ["Content-type: application/json;charset='utf-8'", "Authorization: Basic " . $this->sign];
    ...
    {
        $headers = ["Content-type: multipart/form-data", "Authorization: Basic " . $this->sign];
